...
const CompanyCard: React.FC<CompanyCardProps> = ({
  ...
  return (
    <div className="group p-6 relative overflow-hidden bg-gray-100 shadow-md hover:shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1">
